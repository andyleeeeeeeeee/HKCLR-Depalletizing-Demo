...
def single_file_test():
    ply_path = '/home/andylee/HKCLR-Depalletizing-Demo/depalletizing_ws/src/boxdemo/data/qz/model13.pcd'

    cloud = pcl.load_XYZRGB(ply_path)
    pts = cloud.to_array()
    pts = pts[:, 0 : 3]

    img = cv2.imread('/home/andylee/HKCLR-Depalletizing-Demo/depalletizing_ws/src/boxdemo/data/qz/leftView13.bmp')
